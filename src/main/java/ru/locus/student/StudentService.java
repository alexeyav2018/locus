...
public class StudentService {
     ...
     * одна — Задания; ни Работ, ни отметок не существует; подробности
     * и долг — в {@link StudentUsage}.
     */
     ...
     *
     * <p><b>Каждая из трёх сущностей пополнила эту проверку</b>
     * своей реализацией {@link StudentUsage}:
     *
     * <ul>
     *   <li>Задание — работа {@code assignments}, ответила;</li>
     *   <li>Работа — работа {@code submission-review}, ответила;</li>
     *   <li>отметка Владения — работа {@code mastery-marks}, ответила.</li>
     * </ul>
     *
