...
- [x] 7.1 Тест `AssignmentsAreFilteredByOwnerTest` через HTTP двумя Учителями
...
- [x] 8.2 Проверить признак готовности карточки: выдача Группе из двенадцати
...
- [x] 8.3 Правка документов контекста: `glossary.md` — перечисление
      ...
      **новая строка и карточка `student-withdrawal`** (решение владельца
      ...
      не сработали.
- [x] 8.4 Перевести [ADR-0036](../../context/adr/0036-voprosy-biblioteki-bez-vladelca.md)
