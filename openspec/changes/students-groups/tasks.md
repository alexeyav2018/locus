...
- [ ] 8.1 Тест `StudentsAreFilteredByOwnerTest` через HTTP двумя Учителями,
...
- [ ] 8.2 Тест `StudentIsNotAUserTest`: в таблице `student` ровно колонки
...
- [ ] 9.1 Прогнать `mvn clean package`. Проверка: сборка зелёная.
- [ ] 9.2 Проверить признак готовности карточки: Ученик не имеет учётной записи
...
- [ ] 9.3 Правка документов контекста: `domain-model.md` — Ученик и Группа
...
- [ ] 9.4 Перевести [ADR-0035](../../context/adr/0035-udalenie-uchenika-i-gruppy.md)
